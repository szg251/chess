module Icons.King exposing (black, white)

import Svg exposing (Svg, g, path, rect, svg)
import Svg.Attributes exposing (d, id, style, transform, version, x, y)
...
white rotation posX posY =
    ...
    svg
        ...
        [ g
            [ style ("fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;transform-origin: 22px 22px;transform: " ++ rotate) ]
            [ path
